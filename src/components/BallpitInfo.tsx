  ...
  return (
    ...
    >
      ...
      <p className="text-sm leading-relaxed text-slate-700 md:text-base dark:text-slate-200">
        Den interaktive bakgrunnen på nettsiden er mer enn bare visuell pynt –
        den reagerer på musepeker, berøring og pekeposisjonen fra enheten.
        På nyere iPad-modeller med Apple Pencil aktiveres også hover-teknologi,
        som gjør at du kan påvirke elementene uten å berøre skjermen.
        Det føles nesten som å bruke Kraften – litt Jedi-modus.
      </p>

      <div className="mt-4 flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
        <PenTool className="h-4 w-4" />
        <span>Tips: Apple Pencil-hover støttes på nyere iPad-modeller.</span>
      </div>
    </section>
  );
}