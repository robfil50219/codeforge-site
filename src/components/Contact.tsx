...
export default function Contact() {
  ...
  return (
    <section id="contact" className="scroll-mt-24 relative bg-white" aria-labelledby="contact-heading">
      ...
      <Container className="py-20">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 id="contact-heading" className="text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl">
            {t("contact.heading")}
          </h2>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <div aria-hidden="true" className="pointer-events-none absolute -right-10 -top-10 h-28 w-28 rotate-12 rounded-3xl bg-sky-100 transition duration-300 group-hover:scale-125" />
            <div className="relative flex items-start gap-4">
              <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-sky-50 ring-1 ring-sky-100">
                <Mail className="h-5 w-5 text-sky-600" />
              </span>
              <div>
                <h3 className="text-base font-semibold text-slate-900">{t("contact.email")}</h3>
          ...
          <a
            ...
            className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-lg"
          >
            <div aria-hidden="true" className="pointer-events-none absolute -right-10 -top-10 h-28 w-28 rotate-12 rounded-3xl bg-slate-100 transition duration-300 group-hover:scale-125" />
            <div className="relative flex items-start gap-4">
              <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-slate-50 ring-1 ring-slate-200">
                <Github className="h-5 w-5 text-slate-700" />
              </span>
              <div>
                <h3 className="text-base font-semibold text-slate-900">{t("contact.github")}</h3>
          ...
          <a
            ...
            className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-lg"
          >
            <div aria-hidden="true" className="pointer-events-none absolute -right-10 -top-10 h-28 w-28 rotate-12 rounded-3xl bg-[#eef5fc] transition duration-300 group-hover:scale-125" />
            <div className="relative flex items-start gap-4">
              <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#eef5fc] ring-1 ring-[#d7e8fb]">
                <Linkedin className="h-5 w-5 text-[#0a66c2]" />
              </span>
              <div>
                <h3 className="text-base font-semibold text-slate-900">{t("contact.linkedin")}</h3>
                <p className="mt-1 text-sm text-slate-600">linkedin.com/in/robert-filep-417146264</p>
              </div>
            </div>
          </a>
        </div>
        ...
        <div className="mt-16 overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-r from-sky-50 to-indigo-50 p-6 sm:p-10">
          <div className="mx-auto max-w-3xl">
            <h3 className="text-xl font-semibold text-slate-900 text-center">{t("contact.formTitle")}</h3>
            <p className="mt-2 text-slate-600 text-center">{t("contact.formCopy")}</p>
